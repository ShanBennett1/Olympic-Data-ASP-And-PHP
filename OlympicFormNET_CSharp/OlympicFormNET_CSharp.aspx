...
<script runat="server">
    ...
    int CNTSUBROWS()
    {
        ...
        for (int x = startat; x <= 25; x++)
        {
            if ( !string.IsNullOrEmpty(Request.Form["CompName_R_" + x]) || !string.IsNullOrEmpty(Request.Form["MedalWon_R_" + x]) || !string.IsNullOrEmpty(Request.Form["WorldRecord_R_" + x]) )
            {
                rowsfilled++;
            }
        }
    ...
    bool VALIDCOMPNAME(string name)
    {
        bool invalidname = false;
        if (!(Regex.IsMatch(name, @"^[a-zA-Z -]{5,}$")))
        {
            invalidname=true; 
        }
        return invalidname;
    ...
    bool VALIDMEDAL(string medal)
    {
        bool invalidmedal = false;
        if (!(Regex.IsMatch( medal, @"G|S|B")))
        {
            invalidmedal=true; 
        }
        return invalidmedal;
    ...
    bool VALIDWORLDRECORD(string record)
    {
        bool invalidrecord = false;
        if (!(Regex.IsMatch(record, @"N|Y")))
        {
            invalidrecord=true;
        }
    ...
    bool VALIDCOMDATE(string comdate)
    {
        bool invalidrecord = false;
        if (!(Regex.IsMatch(comdate,  @"^([0-2][0-9]|(3)[0-1])(\/)(((0)[0-9])|((1)[0-2]))(\/)\d{4}$")))
        {
            invalidrecord=true; // if yes, TRUE state
        }
        return invalidrecord;
    }

    bool VALIDENDDATE(string enddate)
    {
        bool invalidrecord = false;
        if (!(Regex.IsMatch(enddate,   @"^([0-2][0-9]|(3)[0-1])(\/)(((0)[0-9])|((1)[0-2]))(\/)\d{4}$")))
        {
            invalidrecord=true; // if yes, TRUE state
        }
        return invalidrecord;
    ...
    bool VALIDATEDATEDIF(string comDate, string endDate)
    {
        bool invalidrecord = false;
        DateTime NewComDate;
        DateTime NewEndDatee;
        
        NewComDate = DateTime.Parse(comDate);
        NewEndDatee = DateTime.Parse(endDate);

        if (NewComDate > NewEndDatee)
         {
            invalidrecord=true;
    ...
    { //Define the error messages
        public const string INVNMEMSG = " Name should be an alphabetic string of at least 5 characters.";
        public const string INVMEDMSG = " Medals should be G, S or B";
        public const string INVWRECMSG = " World Records should be Y or N";
        public const string INVCITYMSG = " City Of Games should be text only and not blank";
        public const string INVYEARMSG = " Year of games should be a four digit number";
        public const string INVCOMDATEMSG = " Commence Date should not be blank and should follow DD/MM/YYYY fortmat";
        public const string INVENDDATEMSG = " End Date should not be blank and should follow DD/MM/YYYY fortmat";
        public const string INVDATEDIFMSG = " End Date should be more than commencement date";
        public const string INVTEXTBOXMSG = " Invalid Entry";
    }


</script>

<% if (Request.Form["CompName_R_1"] != null)
    {
        int blnkrowstoadd = 0;
        int blnkrowsnextinseq = 0;
        int rowstoprocess = 0;
        bool frmissue = false;
        ...
        if (rowstoprocess == 0)
        { // Check to see if no rows have been filled out
            blnkrowstoadd = 25;
            blnkrowsnextinseq = 1;
        }
        else
        ...
        {
            for (int x = 1; x <= rowstoprocess; x++)
            { // Checks if some compulsory row fields have been completed
        ...
        for (int x = 1; x <= rowstoprocess; x++)
        { // Checks if entered values meet business rules

            if (VALIDCOMPNAME(Request.Form["CompName_R_" + x]) == true)
            {
                frmissue = true;              
            }

            if (VALIDMEDAL(Request.Form["MedalWon_R_" + x]) == true)
            {
                frmissue = true;               
            }

            if (VALIDWORLDRECORD(Request.Form["WorldRecord_R_" + x]) == true)
            {
                frmissue = true;             
            }
        ...
        if (VALIDYEAR(Request.Form["YearOfGames"])== true)
        {
            frmissue = true;
        }

        if (VALIDCITY(Request.Form["CityOfGames"])== true)
        {
            frmissue = true;
        }

        if (VALIDCOMDATE(Request.Form["CommenceDate"])== true)
        {
            frmissue = true;
        }

        if (VALIDENDDATE(Request.Form["EndDate"]) == true)
        {
            frmissue = true;
        ...
        if (frmissue == true)
            ...
            <%  Response.Write("<p><strong> Year of Games:</strong>");
                if (VALIDYEAR(Request.Form["YearOfGames"])== true)
                {
                    Response.Write("<input name='YearOfGames' type='text' id='YearOfGames' placeholder='" + Errmsgs.INVTEXTBOXMSG + "' size='4' maxlength='4'/>");
                    Response.Write(Errmsgs.INVNMEMSG + " </br>");
                }
                else
                {
                    Response.Write("<input name='YearOfGames' type='text' id='YearOfGames' value='" + Request.Form["YearOfGames"] + "' size='4' maxlength='4'/>");
                }
                Response.Write("</p>");


                Response.Write("<p><strong>City of Games: </strong>");
                if (VALIDCITY(Request.Form["CityOfGames"])== true)
                {
                    Response.Write("<input name='CityOfGames' type='text' id='CityOfGames' placeholder='" + Errmsgs.INVTEXTBOXMSG + "' size='40' maxlength='40'/>");
                    Response.Write(Errmsgs.INVCITYMSG + " </br>");
                }
                else
                {
                    Response.Write("<input name='CityOfGames' type='text' id='CityOfGames' value='" + Request.Form["CityOfGames"] + "' size='40' maxlength='40'/>");
                }
                Response.Write("</p>");


                Response.Write("<p><strong>Commence Date:</strong>");
                if (VALIDCOMDATE(Request.Form["CommenceDate"])== true)
                {
                    Response.Write("<input name='CommenceDate' type='text' id='CommenceDate' placeholder='" + Errmsgs.INVTEXTBOXMSG + "' size='10' maxlength='10'/>");
                    Response.Write(Errmsgs.INVCOMDATEMSG + " </br>");
                }
                else
                {
                    Response.Write("<input name='CommenceDate' type='text' id='CommenceDate' value='" + Request.Form["CommenceDate"] + "' size='10' maxlength='10'/>");
                }
                Response.Write("</p>");

                Response.Write("<p><strong>End Date</strong>:");
                if (VALIDENDDATE(Request.Form["EndDate"]) == true)
                {
                    Response.Write("<input name='EndDate' type='text' id='EndDate' placeholder='" + Errmsgs.INVTEXTBOXMSG + "' size='10' maxlength='10'/>");
                    Response.Write(Errmsgs.INVENDDATEMSG + " </br>");
                }
                else
                {
                    Response.Write("<input name='EndDate' type='text' id='EndDate' value='" + Request.Form["EndDate"] + "' size='10' maxlength='10'/>");
          ...
          <% 
              ...
              if (rowstoprocess == 0)
              { // Provides different error messages depending on whether the form was incomplete or not filled out at all
                  Response.Write("</strong></td>");                
                  Response.Write("Please provide details for <strong>at least one </strong> ticket recipent before submitting this form");
                  Response.Write("</td>");                
              }
              else
              { // If some form rows were completed, but not fully, then regenerate affected rows with appropriate instructions and field pre-population
                  Response.Write("</strong></td>");                 
                  Response.Write("Please provide the missing information or input issues in blank spaces below and submit the form again");
                  Response.Write("</td>");
              }
              ...
              if (rowstoprocess > 0)
              {
                  for (int x = 1; x <= rowstoprocess; x++)
                  {
                      ...
                      if (string.IsNullOrEmpty(Request.Form["CompName_R_" + x]))
                      { // If the field was empty, let user know to correct it
                          Response.Write("<input type='text' name='CompName_R_" + x + "' id='CompName_R_" + x + "' size='40' maxlength='80'>");
                          Response.Write(Errmsgs.INVNMEMSG);

                      }
                      else if (VALIDCOMPNAME(Request.Form["CompName_R_" + x]) == true)
                      { // Else if invalid value provided, let user know to correct it
                          Response.Write("<input type='text' name='CompName_R_" + x + "' id='CompName_R_" + x + "' placeholder='" + Errmsgs.INVTEXTBOXMSG + "' size='40' maxlength='80' </td> ");
                          Response.Write(Errmsgs.INVNMEMSG);
                      }
                      else
                      { // If the field was not empty, regenerate row as normal, pre-populated with value provided
                          Response.Write("<input type='text' name='CompName_R_" + x + "' id='CompName_R_" + x + "' value='" + Request.Form["CompName_R_" + x] + "' size='40' maxlength='80' </td>");
                      }
                      Response.Write("</td>");
                    
                    //Insert drop down box plus all selection feilds
                    Response.Write("<td align='center'><select id='CountryList_R_" + x + "' name='CountryList_R_" + x +"' >"); %>
                ...
                <%     Response.Write("<td align='center'><select id='Event_R_" + x + "' name='Event_R_" + x + "' >");%>
                ...
                <%
                            ...
                            Response.Write("</strong></td>");
                            Response.Write("<td align='center'>");
                            if (string.IsNullOrEmpty(Request.Form["MedalWon_R_" + x]))
                            { // If the field was empty, let user know to correct it
                                Response.Write("<input type='text' name='MedalWon_R_" + x + "' id='MedalWon_R_" + x + "' size='1' maxlength='1'>");
                                Response.Write(Errmsgs.INVMEDMSG);
                            }
                            else if (VALIDMEDAL(Request.Form["MedalWon_R_" + x]) == true)
                            { // Else if invalid value provided, let user know to correct it
                                Response.Write("<input type='text' name='MedalWon_R_" + x + "' id='MedalWon_R_" + x + "' placeholder='" + Errmsgs.INVTEXTBOXMSG + "' size='1' maxlength='1' </td> ");
                                Response.Write(Errmsgs.INVMEDMSG);
                            }
                            else
                            { // If the field was not empty, regenerate row as normal, pre-populated with value provided
                                Response.Write("<input type='text' name='MedalWon_R_" + x + "' id='MedalWon_R_" + x + "' value='" + Request.Form["MedalWon_R_" + x] + "' size='1' maxlength='1' </td>");
                            }
                            Response.Write("</td>");

                            Response.Write("</strong></td>");
                            Response.Write("<td align='center'>");
                            if (string.IsNullOrEmpty(Request.Form["WorldRecord_R_" + x]))
                            { // If the field was empty, let user know to correct it
                                Response.Write("<input type='text' name='WorldRecord_R_" + x + "' id='WorldRecord_R_" + x + "' size='1' maxlength='1'>");
                                Response.Write(Errmsgs.INVWRECMSG);
                            }
                            else if (VALIDWORLDRECORD(Request.Form["WorldRecord_R_" + x]) == true)
                            { // Else if invalid value provided, let user know to correct it
                                Response.Write("<input type='text' name='WorldRecord_R_" + x + "' id='WorldRecord_R_" + x + "' placeholder='" + Errmsgs.INVTEXTBOXMSG + "' size='1' maxlength='1' </td> ");
                                Response.Write(Errmsgs.INVWRECMSG);
                            }
                            else
                            { // If the field was not empty, regenerate row as normal, pre-populated with value provided
                                Response.Write("<input type='text' name='WorldRecord_R_" + x + "' id='WorldRecord_R_" + x + "' value='" + Request.Form["WorldRecord_R_" + x] + "' size='1' maxlength='1' </td>");
                            }
                            Response.Write("</td>");
                            Response.Write("</tr>");
                    ...
                    for (int x = 1; x <= blnkrowstoadd; x++)
                    {
                        Response.Write("</strong></td>");
                        Response.Write("<td align='center'>");
                        Response.Write("<input type='text' name='CompName_R_" + blnkrowsnextinseq + "' id='CompName_R_" + blnkrowsnextinseq + "' size='40' maxlength='80'>");
                        Response.Write("</td>");


                        Response.Write("<td align='center'><select id='CountryList_R_" + blnkrowsnextinseq + "' name='CountryList_R_" + blnkrowsnextinseq +"' >"); %>
                    <option value="Afghanistan">Afghanistan</option>
                    <option value="Åland Islands">Åland Islands</option>
                    <option value="Albania">Albania</option>
                    <option value="Algeria">Algeria</option>
                    ...
                    <% Response.Write("<td align='center'><select id='Event_R_" + blnkrowsnextinseq + "' name='Event_R_" + blnkrowsnextinseq + "' >");%>
                      <option value="Archery">Archery</option>
                      <option value="Badminton">Badminton</option>
                      <option value="Basketball">Basketball</option>
                      <option value="Beach Volleyball">Beach Volleyball</option>
                  ...
                  Response.Write("</strong></td>");
                  Response.Write("<td align='center'>");
                  Response.Write("<input type='text' name='MedalWon_R_" + blnkrowsnextinseq + "' id='MedalWon_R_" + blnkrowsnextinseq + "' size='1' maxlength='1'>");
                  Response.Write("</td>");

                  Response.Write("</strong></td>");
                  Response.Write("<td align='center'>");
                  Response.Write("<input type='text' name='WorldRecord_R_" + blnkrowsnextinseq + "' id='WorldRecord_R_" + blnkrowsnextinseq + "' size='1' maxlength='1'>");
                  Response.Write("</td>");
                  Response.Write("</tr>");
              ...
              //Add Submit buton for new form
                ...
                <%
                        ...
                        {   //Show Page that shows the processed results
                            ...
                            string[] compName = new string[rowstoprocess];
                            string[] medalWon = new string[rowstoprocess];
                            int[] gMedal = new int[rowstoprocess];
                            int[] bMedal = new int[rowstoprocess];
                            int[] sMedal = new int[rowstoprocess];                            
                            string[] countrys = new string[rowstoprocess];
                           
                            //Fill arrays with information from form
                            for (int x = 1; x <= rowstoprocess; x++)
                            {
                                int indx = x - 1;
                                compName[indx] = Request.Form["CompName_R_" + x];
                                medalWon[indx] = Request.Form["MedalWon_R_" + x];
                                countrys[indx] = Request.Form["CountryList_R_" + x];                            
                            }

                            //Remove any duplicate country names from array
                            string[] dCountrys = countrys.Distinct().ToArray();
                            int[] total = new int [dCountrys.Length];

                            //tally up for each medal for each country
                            for (int x = 0; x < dCountrys.Length; x++)
                            {
                                for (int j = 1; j <= rowstoprocess; j++)
                                {
                                    if (dCountrys[x] == Request.Form["CountryList_R_" + j])
                                    {
                                        if (Request.Form["MedalWon_R_" + j] == "G")
                                        {
                                            gMedal[x] = gMedal[x] + 1;

                                        }
                                        if (Request.Form["MedalWon_R_" + j] == "S")
                                        {
                                            sMedal[x] = sMedal[x] + 1;

                                        }
                                        if (Request.Form["MedalWon_R_" + j] == "B")
                                        {
                                            bMedal[x] = bMedal[x] + 1;
                            ...
                            for(int x = 1; x<=dCountrys.Length; x++)
                            {
                                int indx = x - 1;
                            ...
                            for(int x = 1; x<dCountrys.Length+1; x++)
                            {
                                int indx = x - 1;
                                ...
                                Response.Write ("</strong></td>");
                                Response.Write ("<td align='center'>");
                                Response.Write (dCountrys[indx]);                               
                                Response.Write ("</td>");
                                Response.Write ("<td align='center'>");
                                Response.Write (gMedal[indx]);
                                Response.Write ("</td>");
                                Response.Write ("<td align='center'>");
                                Response.Write (sMedal[indx]);
                                Response.Write ("</td>");
                                Response.Write ("<td align='center'>");
                                Response.Write (bMedal[indx]);
                                Response.Write ("</td>");
                                Response.Write ("<td align='center'>");
                                Response.Write (total[indx]);
                                Response.Write ("</td>");
                                Response.Write("</tr>");
                            ...
                            <td align="center"><strong>Sport</strong></td>
                             ...
                             <% 
                                         ...
                                         for(int x = 1; x<rowstoprocess+1; x++)
                                         {
                                             
                                             if (Request.Form["WorldRecord_R_" + x] == "Y")
                                             {
                                                 ...
                                                 Response.Write("</strong></td>");
                                                 Response.Write("<td align='center'>");
                                                 Response.Write(Request.Form["CompName_R_" + x]);
                                                 Response.Write("</td>");
                                                 Response.Write("<td align='center'>");                                                
                                                 Response.Write(Request.Form["Event_R_" + x]);
                                                 Response.Write("</td>");
                                                 Response.Write("</tr>");
                                                 rNum++;
                                             }
